...
<template>
  <MacAnimList>
    ...
    <li>
      <a class="navItem relative" href="#cooperatedEntities">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
    ...
    <li>
      <a class="navItem relative" href="#recentActions">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
    ...
    <li>
      <a class="navItem relative" href="#certificates">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
    ...
    <li>
      <a class="navItem relative" href="#gifts">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
    ...
    <li>
      <a class="navItem relative" href="#socialMedia">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
