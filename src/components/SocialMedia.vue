  ...
  <MacAnimList>
    <li>
      <a
        ...
        href="https://instagram.com/ht3aa?utm_source=qr&igshid=MzNlNGNkZWQ4Mg=="
      >
        <svg
          version="1.1"
          id="Layer_1"
    ...
    <li>
      <a class="navItem relative" href="https://www.linkedin.com/in/hassan-tahseen-7a4530224/">
        <svg
          height="100%"
          style="
            fill-rule: evenodd;
    ...
    <li>
      <a class="navItem relative" href="https://github.com/ht3aa">
        <svg
    ...
    <li>
      <a class="navItem relative" href="https://t.me/ht3aa">
